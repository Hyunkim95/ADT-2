...
var hasAlg = __webpack_require__(9)
var isFunctor = __webpack_require__(22)
...
var isApply = __webpack_require__(13)
var isArray = __webpack_require__(5)
var isFunction = __webpack_require__(0)
var isSameType = __webpack_require__(3)
...
var _equals = __webpack_require__(17)
var _implements = __webpack_require__(4)
var _innerConcat = __webpack_require__(35)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Maybe')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)

var compose = __webpack_require__(12)
var isApply = __webpack_require__(13)
var isArray = __webpack_require__(5)
var isFunction = __webpack_require__(0)
var isSameType = __webpack_require__(3)
...
function runSequence(x) {
  ...
  return x.map(function (v) { return Maybe.of(v); })
}
...
function Maybe(u) {
  ...
  function traverse(af, f) {
    ...
    return either(
      constant(m),
      constant(m.map(function (v) { return Maybe(v); }))
    )
  }

  return ( obj = {
    inspect: inspect, toString: inspect, either: either,
    option: option, type: type, concat: concat, equals: equals, coalesce: coalesce,
    map: map, alt: alt, zero: zero, ap: ap, of: of, chain: chain, sequence: sequence,
    traverse: traverse
  }, obj[fl.zero] = zero, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.alt] = alt, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Maybe, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Pair')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var isFunction = __webpack_require__(0)
var isSameType = __webpack_require__(3)
var isSemigroup = __webpack_require__(23)
...
function Pair(l, r) {
  ...
  return ( obj = {
    ...
    concat: concat, swap: swap, map: map, bimap: bimap, ap: ap, chain: chain,
    sequence: sequence, traverse: traverse, extend: extend
  }, obj[fl.equals] = equals, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.bimap] = bimap, obj[fl.chain] = chain, obj[fl.extend] = extend, obj['@@type'] = _type, obj.constructor = Pair, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Async')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)

var array = __webpack_require__(15)
var compose = __webpack_require__(12)
var once = __webpack_require__(47)
var unit = __webpack_require__(48)

var isArray = __webpack_require__(5)
var isFoldable = __webpack_require__(16)
var isFunction = __webpack_require__(0)
var isPromise = __webpack_require__(34)
var isSameType = __webpack_require__(3)
...
function Async(fn, parentCancel) {
  ...
  return ( obj = {
    ...
    swap: swap, coalesce: coalesce, map: map, bimap: bimap,
    alt: alt, ap: ap, chain: chain, of: of
  }, obj[fl.of] = of, obj[fl.alt] = alt, obj[fl.bimap] = bimap, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Async, obj )
}
...
var _innerConcat = __webpack_require__(35)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Result')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function runSequence(x) {
  ...
  return x.map(function (v) { return Result.of(v); })
}
...
function Result(u) {
  ...
  function traverse(af, f) {
    ...
    return either(
      constant(m),
      constant(m.map(function (v) { return Result.Ok(v); }))
    )
  }

  return ( obj = {
    inspect: inspect, toString: inspect, equals: equals,
    type: type, either: either, concat: concat, swap: swap, coalesce: coalesce,
    map: map, bimap: bimap, alt: alt, ap: ap, chain: chain, of: of, sequence: sequence,
    traverse: traverse
  }, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.alt] = alt, obj[fl.bimap] = bimap, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Result, obj )
}
...
var _innerConcat = __webpack_require__(35)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Either')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function runSequence(x) {
  ...
  return x.map(function (v) { return Either.of(v); })
}
...
function Either(u) {
  ...
  function traverse(af, f) {
    ...
    return either(
      constant(m),
      constant(m.map(function (v) { return Either.of(v); }))
    )
  }

  return ( obj = {
    inspect: inspect, toString: inspect, either: either,
    type: type, concat: concat, swap: swap, coalesce: coalesce, equals: equals,
    map: map, bimap: bimap, alt: alt, ap: ap, of: of, chain: chain, sequence: sequence,
    traverse: traverse
  }, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.alt] = alt, obj[fl.bimap] = bimap, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Either, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('First')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)

var isSameType = __webpack_require__(3)

var Maybe = __webpack_require__(20)
...
function First(x) {
  ...
  return ( obj = {
    ...
    concat: concat, empty: empty, option: option, type: type,
    valueOf: valueOf
  }, obj[fl.empty] = _empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = First, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Last')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var hasAlg = __webpack_require__(9)
var isApplicative = __webpack_require__(36)
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('List')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var isSameType = __webpack_require__(3)
var isSemigroup = __webpack_require__(23)
var predOrFunc = __webpack_require__(19)
...
var Pred = __webpack_require__(2).proxy('Pred')
...
function List(x) {
  ...
  return ( obj = {
    ...
    head: head, tail: tail, cons: cons, type: type, equals: equals, concat: concat, empty: empty,
    reduce: reduce, reduceRight: reduceRight, fold: fold, filter: filter, reject: reject, map: map,
    ap: ap, of: of, chain: chain, sequence: sequence, traverse: traverse
  }, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.concat] = concat, obj[fl.empty] = empty, obj[fl.map] = map, obj[fl.chain] = chain, obj[fl.reduce] = reduce, obj['@@type'] = _type, obj.constructor = List, obj )
}
...
var _implements = __webpack_require__(4)
var type = __webpack_require__(2).type('Unit')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Unit() {
  ...
  return ( obj = {
    ...
    type: type, equals: equals, concat: concat, empty: empty, map: map, ap: ap,
    of: of, chain: chain
  }, obj[fl.of] = of, obj[fl.empty] = empty, obj[fl.equals] = equals, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Unit, obj )
}
...
var hasAlg = __webpack_require__(9)
var isAlt = __webpack_require__(45)
...
var combinators = {
  applyTo: __webpack_require__(56),
  composeB: __webpack_require__(57),
  constant: __webpack_require__(58),
  flip: __webpack_require__(59),
  identity: __webpack_require__(60),
  substitution: __webpack_require__(61)
}

var crocks = {
  Arrow: __webpack_require__(62),
  Async: __webpack_require__(27),
  Const: __webpack_require__(63),
  Either: __webpack_require__(30),
  Equiv: __webpack_require__(64),
  Identity: __webpack_require__(65),
  IO: __webpack_require__(66),
  List: __webpack_require__(40),
  Maybe: __webpack_require__(41),
  Pair: __webpack_require__(67),
  Pred: __webpack_require__(68),
  Reader: __webpack_require__(69),
  ReaderT: __webpack_require__(70),
  Result: __webpack_require__(28),
  Star: __webpack_require__(71),
  State: __webpack_require__(72),
  Unit: __webpack_require__(73),
  Writer: __webpack_require__(74)
}

var helpers = {
  assign: __webpack_require__(75),
  assoc: __webpack_require__(76),
  binary: __webpack_require__(77),
  branch: __webpack_require__(78),
  compose: __webpack_require__(79),
  composeK: __webpack_require__(80),
  composeP: __webpack_require__(81),
  composeS: __webpack_require__(82),
  curry: __webpack_require__(83),
  defaultProps: __webpack_require__(84),
  defaultTo: __webpack_require__(85),
  dissoc: __webpack_require__(86),
  fanout: __webpack_require__(87),
  fromPairs: __webpack_require__(88),
  liftA2: __webpack_require__(89),
  liftA3: __webpack_require__(90),
  liftN: __webpack_require__(91),
  mapProps: __webpack_require__(92),
  mapReduce: __webpack_require__(93),
  mconcat: __webpack_require__(94),
  mconcatMap: __webpack_require__(95),
  mreduce: __webpack_require__(96),
  mreduceMap: __webpack_require__(97),
  nAry: __webpack_require__(98),
  objOf: __webpack_require__(99),
  omit: __webpack_require__(100),
  once: __webpack_require__(101),
  partial: __webpack_require__(102),
  pick: __webpack_require__(103),
  pipe: __webpack_require__(104),
  pipeK: __webpack_require__(105),
  pipeP: __webpack_require__(106),
  pipeS: __webpack_require__(107),
  prop: __webpack_require__(108),
  propPath: __webpack_require__(109),
  propOr: __webpack_require__(110),
  propPathOr: __webpack_require__(111),
  safe: __webpack_require__(52),
  safeLift: __webpack_require__(112),
  tap: __webpack_require__(113),
  toPairs: __webpack_require__(114),
  tryCatch: __webpack_require__(115),
  unary: __webpack_require__(116),
  unit: __webpack_require__(117)
}

var logic = {
  and: __webpack_require__(118),
  ifElse: __webpack_require__(119),
  not: __webpack_require__(120),
  or: __webpack_require__(121),
  unless: __webpack_require__(122),
  when: __webpack_require__(123)
}

var monoids = {
  All: __webpack_require__(124),
  Any: __webpack_require__(125),
  Assign: __webpack_require__(126),
  Endo: __webpack_require__(127),
  First: __webpack_require__(32),
  Last: __webpack_require__(33),
  Max: __webpack_require__(128),
  Min: __webpack_require__(129),
  Prod: __webpack_require__(130),
  Sum: __webpack_require__(131),
}

var pointfree = {
  alt: __webpack_require__(132),
  ap: __webpack_require__(133),
  bimap: __webpack_require__(134),
  both: __webpack_require__(135),
  chain: __webpack_require__(136),
  coalesce: __webpack_require__(137),
  compareWith: __webpack_require__(138),
  concat: __webpack_require__(139),
  cons: __webpack_require__(140),
  contramap: __webpack_require__(141),
  either: __webpack_require__(142),
  empty: __webpack_require__(143),
  equals: __webpack_require__(144),
  evalWith: __webpack_require__(145),
  execWith: __webpack_require__(146),
  extend: __webpack_require__(147),
  filter: __webpack_require__(148),
  first: __webpack_require__(149),
  fold: __webpack_require__(150),
  fst: __webpack_require__(151),
  head: __webpack_require__(152),
  log: __webpack_require__(153),
  map: __webpack_require__(154),
  merge: __webpack_require__(155),
  option: __webpack_require__(156),
  promap: __webpack_require__(157),
  read: __webpack_require__(158),
  reduce: __webpack_require__(159),
  reduceRight: __webpack_require__(160),
  reject: __webpack_require__(161),
  run: __webpack_require__(162),
  runWith: __webpack_require__(163),
  second: __webpack_require__(164),
  sequence: __webpack_require__(165),
  snd: __webpack_require__(166),
  swap: __webpack_require__(167),
  tail: __webpack_require__(168),
  traverse: __webpack_require__(169),
  valueOf: __webpack_require__(170)
}

var predicates = {
  hasProp: __webpack_require__(171),
  hasPropPath: __webpack_require__(172),
  isAlt: __webpack_require__(173),
  isAlternative: __webpack_require__(174),
  isApplicative: __webpack_require__(175),
  isApply: __webpack_require__(176),
  isArray: __webpack_require__(177),
  isBifunctor: __webpack_require__(178),
  isBoolean: __webpack_require__(180),
  isCategory: __webpack_require__(181),
  isChain: __webpack_require__(182),
  isContravariant: __webpack_require__(183),
  isDefined: __webpack_require__(184),
  isEmpty: __webpack_require__(185),
  isExtend: __webpack_require__(186),
  isFoldable: __webpack_require__(187),
  isFunction: __webpack_require__(188),
  isFunctor: __webpack_require__(189),
  isInteger: __webpack_require__(190),
  isMonad: __webpack_require__(191),
  isMonoid: __webpack_require__(192),
  isNil: __webpack_require__(193),
  isNumber: __webpack_require__(194),
  isObject: __webpack_require__(195),
  isPlus: __webpack_require__(196),
  isProfunctor: __webpack_require__(197),
  isPromise: __webpack_require__(198),
  isSame: __webpack_require__(199),
  isSameType: __webpack_require__(200),
  isSemigroup: __webpack_require__(201),
  isSemigroupoid: __webpack_require__(202),
  isSetoid: __webpack_require__(203),
  isString: __webpack_require__(204),
  isTraversable: __webpack_require__(205),
  propEq: __webpack_require__(206),
  propPathEq: __webpack_require__(207),
}

var transforms = {
  arrayToList: __webpack_require__(208),
  eitherToAsync: __webpack_require__(209),
  eitherToFirst: __webpack_require__(210),
  eitherToLast: __webpack_require__(211),
  eitherToMaybe: __webpack_require__(212),
  eitherToResult: __webpack_require__(213),
  firstToAsync: __webpack_require__(214),
  firstToEither: __webpack_require__(215),
  firstToLast: __webpack_require__(216),
  firstToMaybe: __webpack_require__(217),
  firstToResult: __webpack_require__(218),
  lastToAsync: __webpack_require__(219),
  lastToEither: __webpack_require__(220),
  lastToFirst: __webpack_require__(221),
  lastToMaybe: __webpack_require__(222),
  lastToResult: __webpack_require__(223),
  listToArray: __webpack_require__(224),
  maybeToAsync: __webpack_require__(225),
  maybeToEither: __webpack_require__(226),
  maybeToFirst: __webpack_require__(227),
  maybeToLast: __webpack_require__(228),
  maybeToResult: __webpack_require__(229),
  resultToAsync: __webpack_require__(230),
  resultToEither: __webpack_require__(231),
  resultToFirst: __webpack_require__(232),
  resultToLast: __webpack_require__(233),
  resultToMaybe: __webpack_require__(234),
  writerToPair: __webpack_require__(235)
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Arrow')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var Pair = __webpack_require__(2).proxy('Pair')
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Const')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var type = __webpack_require__(2).type('Equiv')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Equiv(compare) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, type: type,
    compareWith: compareWith, valueOf: valueOf, contramap: contramap,
    concat: concat, empty: empty
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj[fl.contramap] = contramap, obj['@@type'] = _type, obj.constructor = Equiv, obj )
}
...
var _innerConcat = __webpack_require__(35)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Identity')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Identity(x) {
  ...
  function sequence(af) {
    ...
    return x.map(function (v) { return Identity(v); })
  }
  ...
  function traverse(af, f) {
    ...
    return m.map(function (v) { return Identity(v); })
  }

  return ( obj = {
    inspect: inspect, toString: inspect, valueOf: valueOf,
    type: type, equals: equals, concat: concat, map: map, ap: ap, of: of,
    chain: chain, sequence: sequence, traverse: traverse
  }, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.concat] = concat, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Identity, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('IO')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function IO(run) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, run: run,
    type: type, map: map, ap: ap, of: of, chain: chain
  }, obj[fl.of] = of, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = IO, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Pred')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Pred(pred) {
  ...
  return ( obj = {
    ...
    type: type, valueOf: valueOf, empty: empty, concat: concat, contramap: contramap
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj[fl.contramap] = contramap, obj['@@type'] = _type, obj.constructor = Pred, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Reader')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Reader(runWith) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, runWith: runWith,
    type: type, map: map, ap: ap, chain: chain, of: of
  }, obj[fl.of] = of, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = Reader, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var _type = __webpack_require__(2).type('Reader')()
var _typeString = __webpack_require__(2).typeFn(_type, VERSION)
var fl = __webpack_require__(6)

var curry = __webpack_require__(1)
var isFunction = __webpack_require__(0)
var isMonad = __webpack_require__(42)
var isSameType = __webpack_require__(3)
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var _type = __webpack_require__(2).type('Star')
var __type = __webpack_require__(2).typeFn(_type(), VERSION)
var fl = __webpack_require__(6)
...
var Pair = __webpack_require__(24)
...
function _Star(Monad) {
  ...
  function Star(runWith) {
    ...
    return ( obj = {
      ...
      runWith: runWith, id: id, compose: compose, map: map, contramap: contramap,
      promap: promap, first: first, second: second, both: both
    }, obj[fl.id] = id, obj[fl.compose] = compose, obj[fl.contramap] = contramap, obj[fl.map] = map, obj[fl.promap] = promap, obj['@@type'] = typeString, obj.constructor = Star, obj )
  }
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('State')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)

var Pair = __webpack_require__(24)
var Unit = __webpack_require__(51)
...
function State(fn) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, runWith: runWith,
    execWith: execWith, evalWith: evalWith, type: type, map: map, ap: ap,
    chain: chain, of: of
  }, obj[fl.of] = of, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = _type, obj.constructor = State, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var __type = __webpack_require__(2).type('Writer')()
var _typeString = __webpack_require__(2).typeFn(__type, VERSION)
var fl = __webpack_require__(6)

var Pair = __webpack_require__(24)

var isFunction = __webpack_require__(0)
var isMonoid = __webpack_require__(29)
var isSameType = __webpack_require__(3)
...
function _Writer(Monoid) {
  ...
  function Writer(entry, val) {
    ...
    return ( obj = {
      ...
      valueOf: valueOf, log: log, type: type, equals: equals, map: map,
      ap: ap, of: of, chain: chain
    }, obj[fl.of] = of, obj[fl.equals] = equals, obj[fl.map] = map, obj[fl.chain] = chain, obj['@@type'] = typeString, obj.constructor = Writer, obj )
  }
...
var curryN = __webpack_require__(43)
var isFunction = __webpack_require__(0)
...
var isChain = __webpack_require__(37)
var isFunction = __webpack_require__(0)
...
var isSameType = __webpack_require__(3)
var isSemigroupoid = __webpack_require__(31)
...
var curry = __webpack_require__(1)
var isContravariant = __webpack_require__(44)
var isFunction = __webpack_require__(0)
var isSameType = __webpack_require__(3)
var isSemigroupoid = __webpack_require__(31)
...
var isFoldable = __webpack_require__(16)
var isMonoid = __webpack_require__(29)
var mconcatMap = __webpack_require__(38)
...
var _mconcatMap = __webpack_require__(38)
var curry = __webpack_require__(1)
var isFoldable = __webpack_require__(16)
var isFunction = __webpack_require__(0)
var isMonoid = __webpack_require__(29)
...
var curry = __webpack_require__(1)
var isDefined = __webpack_require__(21)
var isEmpty = __webpack_require__(14)
var isNil = __webpack_require__(10)
var isInteger = __webpack_require__(18)
var isString = __webpack_require__(8)
...
var isFunction = __webpack_require__(0)
var isSameType = __webpack_require__(3)
var safe = __webpack_require__(52)
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('All')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function All(b) {
  ...
  }, obj['@@type'] = _type, obj[fl.concat] = concat, obj[fl.empty] = empty, obj.constructor = All, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Any')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Any(b) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect,
    valueOf: valueOf, type: type, concat: concat, empty: empty
  }, obj['@@type'] = _type, obj[fl.concat] = concat, obj[fl.empty] = empty, obj.constructor = Any, obj )
}
...
var type = __webpack_require__(2).type('Assign')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Endo')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Endo(runWith) {
  ...
  return ( obj = {
    ...
    valueOf: valueOf, type: type, concat: concat, empty: empty,
    runWith: runWith
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = Endo, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Max')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Max(n) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, valueOf: valueOf,
    type: type, concat: concat, empty: empty
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = Max, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Min')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Min(n) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, valueOf: valueOf,
    type: type, concat: concat, empty: empty
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = Min, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Prod')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Prod(n) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, valueOf: valueOf,
    type: type, concat: concat, empty: empty
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = Prod, obj )
}
...
var _implements = __webpack_require__(4)
var _inspect = __webpack_require__(7)
var type = __webpack_require__(2).type('Sum')
var _type = __webpack_require__(2).typeFn(type(), VERSION)
var fl = __webpack_require__(6)
...
function Sum(n) {
  ...
  return ( obj = {
    inspect: inspect, toString: inspect, valueOf: valueOf,
    type: type, concat: concat, empty: empty
  }, obj[fl.empty] = empty, obj[fl.concat] = concat, obj['@@type'] = _type, obj.constructor = Sum, obj )
}
...
var curry = __webpack_require__(1)
var isExtend = __webpack_require__(53)
var isFunction = __webpack_require__(0)
...
var isApplicative = __webpack_require__(36)
var isPlus = __webpack_require__(54)
...
var Either = __webpack_require__(2).proxy('Either')
...
var Maybe = __webpack_require__(41)
var Either = __webpack_require__(2).proxy('Either')
...
var Async = __webpack_require__(27)
var First = __webpack_require__(2).proxy('First')
...
var Either = __webpack_require__(30)
var First = __webpack_require__(2).proxy('First')
...
var Async = __webpack_require__(27)
var Last = __webpack_require__(2).proxy('Last')
...
var Async = __webpack_require__(27)
var Maybe = __webpack_require__(2).proxy('Maybe')
...
var Async = __webpack_require__(27)
var Result = __webpack_require__(2).proxy('Result')
